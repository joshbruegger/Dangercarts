...
# high damage
# execute if score out math_sqrt > kc.global kc_high run damage @e[type=!#dangercarts:not_mob,distance=0..1.5, limit=1,tag=!kc_passenger] 40 minecraft:mace_smash by @e[tag=kc_actual_slime,limit=1] from @e[tag=kc_actual_slime,limit=1]
...
# medium damage
# execute if score out math_sqrt > kc.global kc_medium unless score out math_sqrt > kc.global kc_high run damage @e[type=!#dangercarts:not_mob,distance=0..1.5, limit=1,tag=!kc_passenger] 12 minecraft:mace_smash by @e[tag=kc_actual_slime,limit=1] from @e[tag=kc_actual_slime,limit=1]
...
# low damage
# execute if score out math_sqrt > kc.global kc_low unless score out math_sqrt > kc.global kc_medium run damage @e[type=!#dangercarts:not_mob,distance=0..1.5, limit=1,tag=!kc_passenger] 6 minecraft:mace_smash by @e[tag=kc_actual_slime,limit=1] from @e[tag=kc_actual_slime,limit=1]
...
# execute as @s run function dangercarts:deal_damage with storage dangercarts:config kc_high_damage
